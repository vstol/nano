...
iPrintLnBold("^3--> ^7" +player.name+ "^1 has entered ^1StationFight! ^3<--");
wait(0.05);
...
trigger waittill("trigger", player);
iPrintLnBold("^3--> ^7" +player.name+ "^1 is on its way to the top ! ^3<--");
...
wait(0.5);
iPrintLnBold("^3--> ^7" +player.name+ "^1 has entered the sniper room ^3<--"); 
...
wait(0.05);
player iPrintLnBold("Welcome to the secret room !"); 
level.triggerback waittill("trigger", player);
player iPrintLnBold("^3--> ^1Teleport back to map ^3<--"); 
...
wait(0.05);
player iPrintLnBold("Welcome to the JumpGame !"); 
if(isdefined(level.activ))
{
level.activ freezeControls( true );
wait(0.5);
...
level.activ iPrintLnBold("Welcome to the JumpGame !"); 
level.activ freezeControls( false );
}
}
}
...
if( count == 2 )
{
iPrintLnBold("last standing tele"); 
...
if( isDefined( level.trapsDisabled ) && level.trapsDisabled)
{
player iPrintLnBold("Want to burn your hands ?"); 
}
else
{
