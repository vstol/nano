...
init()
{
    ...
    setdvar("g_TeamColor_Allies", "0.0 0.8 0.0");
    setdvar("g_ScoresColor_Allies", "0.0 0.8 0.0");

	setdvar("g_TeamName_Axis", "^1Activator");
	setdvar("g_TeamIcon_Axis", "killiconsuicide");
    setdvar("g_TeamColor_Axis", "1.0 0.0 0.0");
    setdvar("g_ScoresColor_Axis", "1.0 0.0 0.0");

    setdvar("g_ScoresColor_Spectator", "1 0.26 0.26");
    setdvar("g_ScoresColor_Free", "1 0.26 0.26");
    setdvar("g_teamColor_MyTeam", "1 0.26 0.26");
    setdvar("g_teamColor_EnemyTeam", "1 0.26 0.26");
...
{	
	...
	info[0]["hud"].sort = -1;
	info[1]["stat"] = "kills";
	info[1]["hud"] = addIconHud( level, 290, 130+addY, 0, "dtimer_1", 60, 59 ); // @FIXME
	info[1]["hud"].sort = -1;
	info[2]["stat"] = "knifes";
	info[2]["hud"] = addIconHud( level, 290, 130+addY, 0, "dtimer_2", 60, 59 );
	info[2]["hud"].sort = -1;
	info[3]["stat"] = "headshots";
	info[3]["hud"] = addIconHud( level, 290, 130+addY, 0, "dtimer_3", 60, 59 );
	info[3]["hud"].sort = -1;
	info[4]["stat"] = "time";
