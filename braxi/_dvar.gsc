...
setupDvars()
{
	...
	addDvar( "drui_ability", "drui_ability", 1, 0, 1, "int" );
	...
	addDvar( "motd", "dr_motd", "Welcome to ^1|RS|2DeathRun! ^1Visit ^3www.royalsoldiers.net ^7:)", "", "", "string" );
	makeDvarServerInfo( "dr_motd", level.dvar["motd"] );

	addDvar( "logPrint", "g_printlogs", 1, 0, 1, "int" );
	...
	addDvar( "messages", "dr_messages", "This server is running DeathRun 1.2 Edited By Crazy ;Visit www.royalsoldiers.net for updates and maps", "", "", "string" );
	addDvar( "lastmessage", "dr_lastmessage", "Visit www.royalsoldiers.net", "", "", "string" );
	...
	addDvar( "shots", "dr_shots", "", "", "", "init" );
	addDvar( "hit", "dr_hits", "", "", "", "init" );
	addDvar( "accuracy", "dr_accuracy", "", "", "", "string" );
