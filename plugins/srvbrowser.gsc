...
init()
{	
	level.clientcmd_script = braxi\_common::clientCmd;
	//level.clientcmd_script = maps\mp\gametypes\_misc::ExecClientCommand;
	//level.clientcmd_script = duffman\admincmd::clientCmd;
	precacheshader("line_vertical");
	precacheshader("dollar");
	level.brwstat = 414;
	//servernames and their ports
	level.srvs[28951] = "^2RS^7' ^7Hardcore SnD";//strange bug.. srvnames cant start with ^1
	level.srvs[28952] = "^2RS^7' ^7Hardcore TDM";
	level.srvs[28953] = "^2RS^7' ^7Domination";
	level.srvs[28954] = "^2RS^7' ^7Sabotoge";
	level.srvs[28945] = "^2RS^7' ^7headquarters";
	level.srvs[28957] = "^2RS^7' ^7Promod216 S&D";
	level.srvs[28958] = "^2RS^7' ^7Promod220 S&D";
	level.srvs[28956] = "^2RS^7' ^7ROTU";
	level.srvs[28949] = "^2RS^7' ^7Rozo";
...
ServerBrowser()
{
	...
	self.serverbrowser[0] SetShader("dollar",550,290);
