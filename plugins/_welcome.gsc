...
init( modVersion )
{
	braxi\_dvar::addDvar( "welcome_message1", "welcome_message1", "^2Welcome To ^1|RS|^2DeathRun 1.2", "", "", "string" );
	braxi\_dvar::addDvar( "welcome_message2", "welcome_message2", "^3Play Fair And Have Fun", "", "", "string" );

	if( getDvar( "welcome_player" ) == "" )
		setDvar( "welcome_player", "1" );
